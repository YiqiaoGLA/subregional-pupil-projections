...
projections <- fread("output_projections/initial_tenyear/year_one_projections_2023_2032_ratio_ets.csv")
...
png(file = "plots/all_years_ten_year_forecast/year_one_tenyear.png",
